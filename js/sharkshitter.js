...
WelcomeState.prototype.enter = function(game) {
    ...
    game.sounds.init();
    game.sounds.loadSound('shoot', 'sounds/splat.mp3');
    game.sounds.loadSound('bang', 'sounds/squish.mp3');
    game.sounds.loadSound('explosion', 'sounds/aah.mp3');
    game.sounds.loadSound('underwater', 'sounds/underwater.mp3');
};
...
WelcomeState.prototype.draw = function(game, dt, ctx) {
    ...
    ctx.fillText(">> SUPER SHARK SHITTER <<", game.width / 2, game.height/2 - 40);
    ctx.font="16px Arial";
...
PlayState.prototype.enter = function(game) {
    ...
    //  Create the ship.
    this.ship = new Ship(game.width / 2, 200);
    ...
    for(var rank = 0; rank < ranks; rank++){
        for(var file = 0; file < files; file++) {
            invaders.push(new Invader(
                ...
                (game.gameBounds.bottom - rank * 20),
                rank, file, 'Invader'));
        }
    }
...
PlayState.prototype.draw = function(game, dt, ctx) {
    ...
    //Draw Oshea
    var oshea = document.getElementById("oshea");
    ctx.drawImage(oshea, this.ship.x - (this.ship.width / 2), this.ship.y - (this.ship.height / 2));

    //  Draw sharks
    var shark = document.getElementById("shark");
    for(var i=0; i<this.invaders.length; i++) {
        var invader = this.invaders[i];
        ctx.drawImage(shark, invader.x - invader.width/2, invader.y - invader.height/2, invader.width + 1, invader.height + 1);
    }
...
PlayState.prototype.fireRocket = function() {
    ...
    {
        //  Add a rocket.
        this.rockets.push(new Rocket(this.ship.x, this.ship.y + 10, this.config.rocketVelocity));
